...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        ...
        DATABASE=os.path.join(app.instance_path, 'tastytable.sqlite'),
    )
    ...
    @app.route('/contact')        
    def contact():
        #adding this for contact page to work
    ...
    # if blog was hosted in its BP at '/', should this rule be '/blog'?
    app.add_url_rule('/', endpoint='index')
    
    from . import recipe
    app.register_blueprint(recipe.bp)
    # if recipe was hosted in its BP at '/', should this rule be '/recipe'?
    # wondering if the url suffix should be here or in the bp
    app.add_url_rule('/', endpoint='index')
